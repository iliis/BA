...
%READ_CAMERA_TRAJECTORY loads 'camera_trajectory_relative.csv' and returns it as matrix
...
trajectory_data = csvread(fullfile(input_path, 'camera_trajectory_relative.csv'), 1, 0);
